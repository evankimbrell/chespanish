// data.jsx — fixture data shared across screens
const SCENARIOS = [
...
// — Lesson outline + transcript for the player —
const LESSON = {
...
const TENES_EXAMPLES = [
  '¿Tenés tiempo?', '¿Tenés hambre?', '¿Tenés ganas de salir?',
  '¿Tenés efectivo?', '¿Tenés el número?', '¿Tenés idea?',
  '¿Tenés un segundo?', '¿Tenés Whatsapp?',
];

Object.assign(window, { SCENARIOS, FOCUSES, RECENT_MISTAKES, GRAMMAR_TOPICS, LESSON, RECENT_LESSONS, COMMON_MISTAKES, TENES_EXAMPLES });

...
RIOPLATENSE "SH" SOUND (ll / y) — TRANSCRIPTION ARTIFACT, NOT AN ERROR: In Argentine Spanish, "ll" and "y" are pronounced as a "sh"/"zh" sound (sheísmo) — this is the CORRECT target accent and should be REWARDED (it raises target_style_alignment), never penalized. Whisper frequently mis-spells that sound as "x", "sh", "ch", "j", or "g" (e.g. it writes "AXÉR" for a correctly-said "ayer", "xo"/"sho" for "yo", "cashe" for "calle", "shamo" for "llamo", "plasha" for "playa"). When the transcript matches the expected/acceptable response EXCEPT that a word's "ll"/"y" shows up as one of these sh-like spellings, treat it as if the learner said the proper word with a good Argentine accent: do NOT flag a pronunciation or grammar error, do NOT lower the score for it, and grade as if the word were spelled correctly. Only apply this when the rest of the word/phrase still matches the expected answer — do NOT excuse a genuinely different word.

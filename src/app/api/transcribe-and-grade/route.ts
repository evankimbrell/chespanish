...
- calque: Word-for-word English-to-Spanish translations that are grammatically valid but unnatural ("hace sentido" → "tiene sentido"; "cambiar mi mente" → "cambiar de opinión"; "estoy excitado" when meaning thrilled/excited → "estoy emocionado"; "tener un buen tiempo" → "pasarla bien")
